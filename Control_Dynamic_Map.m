...
% Monitoraggio della data di modifica del matfile
matfile_path = 'diff_worldmapping.mat';
last_modified_time = 0; % Inizialmente il file non è stato modificato
...
for t = 1 : T_MAX
    ...
    for i = 1 : Nobst
        ...
        bcbf(i) = 2*(xBall-ballWorld.obstacles{i}.center)'*uBall + 5e2 * (norm(xBall-ballWorld.obstacles{i}.center)^2-ballWorld.obstacles{i}.radius^2);
    end
